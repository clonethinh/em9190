...
<head>
    ...
    * {
    ...
    .ping-unreachable {
      ...
      color: #666;             /* Xám đậm hơn */
      font-style: italic;      /* In nghiêng tạo cảm giác thông báo */
    }
...
<body data-theme="dark">
    ...
    <div class="container">
        <div class="header">
            ...
            <div id="statusBadge" class="status-badge status-loading">Đang làm mới...</div>
        </div>
    ...
    <script>
        ...
        function loadData() {
            document.getElementById('statusBadge').textContent = 'Đang làm mới...';
            ...
            fetch('/cgi-bin/em9190-info')
                ...
                .then(data => {
                    ...
                    // Gán giá trị
                    pingElem.textContent = ping !== "-" ? `${ping} ms` : "Không phản hồi";
        ...
        // Cập nhật Ping mỗi 5 giây (5000 ms)
        setInterval(updatePingInfo, 5000);
